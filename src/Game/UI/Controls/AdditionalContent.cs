...
public static class AdditionalContent
{
	...
	public static void SetGeometry(Control obj, Geometry? value) => obj.SetValue(GeometryProperty, value);

	public static Geometry? GetGeometry(Control obj) => obj.GetValue(GeometryProperty);
}
