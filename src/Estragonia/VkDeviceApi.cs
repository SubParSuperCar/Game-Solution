...
internal sealed unsafe class VkDeviceApi
{
	...
	private readonly delegate* unmanaged[Stdcall]<VkCommandBuffer, VkPipelineStageFlags, VkPipelineStageFlags, VkDependencyFlags
		, uint,
		IntPtr, uint, IntPtr, uint, VkImageMemoryBarrier*, void> _vkCmdPipelineBarrier;

	// Provided by VK_VERSION_1_0
	private readonly delegate* unmanaged[Stdcall]<VkDevice, ref VkCommandPoolCreateInfo, IntPtr, out VkCommandPool, VkResult>
	...
	public VkDeviceApi(VkDevice vkDevice, delegate* unmanaged[Stdcall]<VkDevice, byte*, IntPtr> vkGetDeviceProcAddr)
	{
		...
		_vkCmdPipelineBarrier =
			(delegate* unmanaged[Stdcall]<VkCommandBuffer, VkPipelineStageFlags, VkPipelineStageFlags, VkDependencyFlags, uint,
				IntPtr, uint
				, IntPtr, uint, VkImageMemoryBarrier*, void>)
